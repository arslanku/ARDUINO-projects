...
#define R_Led 4      // Пин D4, красный светодиод
#define Y_Led 8      // Пин D6, желтый светодиод
#define G_Led 6      // Пин D8, зеленый светодиод
#define buzzerPin 10 // Пин для пищалки
