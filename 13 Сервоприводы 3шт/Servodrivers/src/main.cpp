...
#include "lib/ServoSmooth/src/ServoSmooth.h"
ServoSmooth servo1;
ServoSmooth servo2;
ServoSmooth servo3;

#include "lib/EncButton/src/EncButton.h"
EncButton<EB_TICK, BTN1_PIN> btn1;
EncButton<EB_TICK, BTN2_PIN> btn2;
EncButton<EB_TICK, BTN3_PIN> btn3;

#include "lib/GyverWDT/src/GyverWDT.h"
